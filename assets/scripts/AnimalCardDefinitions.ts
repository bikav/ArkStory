...
export const PROTOTYPE_WHITE_ANIMAL_CARDS: readonly AnimalCardDefinition[] = [
  {
    cardId: 'W01',
    name: '林间兔',
    artResourcePath: 'textures/animal_cards/W01_LinJianTu/spriteFrame',
    rarity: 'white',
    cost: 1,
    cubeSlots: 3,
    spiritIconCount: 3,
  ...
  },
  {
    cardId: 'W02',
    name: '溪流蛙',
    artResourcePath: 'textures/animal_cards/W02_XiLiuWa/spriteFrame',
    rarity: 'white',
    cost: 1,
    cubeSlots: 3,
    spiritIconCount: 3,
  ...
  },
  {
    cardId: 'W03',
    name: '旧墙猫',
    artResourcePath: 'textures/animal_cards/W03_JiuQiangMao/spriteFrame',
    rarity: 'white',
    cost: 1,
    cubeSlots: 3,
    spiritIconCount: 3,
