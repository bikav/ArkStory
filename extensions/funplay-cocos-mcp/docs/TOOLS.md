...
Generated from `lib/tool-registry.js`. The default `core` profile exposes 37 tools; the `full` profile exposes 102 tools.
...
| `full` | 102 | All built-in tools, including destructive and low-level helpers. |
